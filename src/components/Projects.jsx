...
import { ChevronLeft, ChevronRight, FileText, X, ArrowUpRight } from "lucide-react";
    ...
    <section id="projects" ref={rootRef} className="px-6 py-28 sm:px-12">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-4 font-display text-xl italic text-muted">
          Documented like technical drawings. Built like instruments.
        </p>
